...
export default function Hero() {
  return (
    <section className="bg-linear-to-r from-orange-50 to-zinc-100">
      <div className="mx-auto flex max-w-6xl flex-col-reverse items-center gap-10 px-4 sm:px-6 py-12 sm:py-16 md:flex-row md:justify-between">
        {/* Left: the text */}
        <div className="max-w-lg text-center md:text-left">
          ...
          <h1 className="mt-3 text-3xl leading-tight font-bold text-zinc-900 sm:text-4xl md:text-5xl">
        ...
        <div className="relative h-44 w-44 shrink-0 overflow-hidden rounded-full bg-white shadow-sm sm:h-56 sm:w-56 md:h-64 md:w-64">
          <Image
            src="/hero-watch.jpg"
            alt="Smart watch"
            fill
